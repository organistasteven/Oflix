...
{
    /**
     * @Route("/", name="app_backoffice_casting_index", methods={"GET"})
     */
    ...
    /**
     * @Route("/new", name="app_backoffice_casting_new", methods={"GET", "POST"})
     */
    public function new(Request $request, CastingRepository $castingRepository): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('app_backoffice_casting_index', [], Response::HTTP_SEE_OTHER);
        }
    ...
    /**
     * @Route("/{id}", name="app_backoffice_casting_show", methods={"GET"})
     */
    ...
    /**
     * @Route("/{id}/edit", name="app_backoffice_casting_edit", methods={"GET", "POST"})
     */
    ...
    /**
     * @Route("/{id}", name="app_backoffice_casting_delete", methods={"POST"})
     */
